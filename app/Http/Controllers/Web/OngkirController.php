...
class OngkirController extends Controller
{
    ...
    public function index(Request $request){
        ...
        return view('eccomerce/Ongkir',['ongkir' => $ongkir]);
    } 
    public function view_ongkir(){
        $daerah = Desas::all();
        return view('eccomerce/TambahOngkir',['daerah'=>$daerah]);
    }
    public function view_edit_ongkir(Request $request,$id){
        $desa = Desas::all();
        $ongkirs = Ongkirs::find($id);
        return view('eccomerce/EditOngkir',['ongkirs'=>$ongkirs,
            'desa' => $desa
        ]);
    }
    public function input_ongkir(request $request)
    {
        ...
        $ongkirs->save();
        return redirect()->route('ongkir.eccommerce')
