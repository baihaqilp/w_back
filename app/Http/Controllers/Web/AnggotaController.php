...
class AnggotaController extends Controller
{
    ...
    {
        return view('eccomerce/TambahAnggota');
    }
    ...
    public function angkat_korus(request $request,$id){
        ...
        if($angkat){
            return redirect()->route('anggota.eccommerce')->with('success','Pengangkatan Korus Berhasil');
        }
    }
    public function angkat_rantus(request $request,$id){
        ...
        if($angkat){
            return redirect()->route('anggota.eccommerce')->with('success','Pengangkatan Rantus Berhasil');
        }
    }
    public function hapus_korus($id){
        ...
        if($angkat){
            return redirect()->route('anggota.eccommerce')->with('success','Korus Berhasil dicabut');
        }
    }
    public function hapus_rantus($id){
        ...
        if($angkat){
            return redirect()->route('anggota.eccommerce')->with('success','Rantus Berhasil dicabut');
        }
    }
