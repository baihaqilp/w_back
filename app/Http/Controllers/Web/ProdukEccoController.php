...
class ProdukEccoController extends Controller
{
    public function index(Request $request){
        ...
        return view('eccomerce/produk',['produks'=>$produks,'kategoris'=>$kategoris]);
    }
    ...
    public function view_tambah_gambar(Request $request,$id){
        ...
        return view('eccomerce/TambahGambarProduk',['produk'=>$produk]);
    }

    public function tambah_gambar(Request $request,$id){
        $produk = Produks::find($id);
        foreach(json_decode($produk->image) as $images){
            $data[]= $images;
        }
        ...
        return redirect()->route('produk.eccommerce')
    ...
    public function view_update_produk(request $request,$id){
        ...
        $kategoris = Kategoris::all();
        return view('eccomerce/EditProduk',['produk'=>$produk,'kategoris'=>$kategoris,'produk_kategori' => $produk_kategori]);
    }
    ...
    public function form_produk(){
        $kategoris = Kategoris::all();
        return view('eccomerce/tambah_produk',['kategoris'=>$kategoris]);
    }
    ...
    public function tampil($id){
        ...
        return redirect()->route('produk.eccommerce')->with('tampil_success','Berhasil Menampilkan Produk Di Aplikasi Eccommerce');
    }
    ...
    public function hide($id){
        ...
        return redirect()->route('produk.eccommerce')->with('hide_success','Berhasil Menyembunyikan Produk Di Aplikasi Eccommerce');
    }
