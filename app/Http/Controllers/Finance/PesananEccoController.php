...
class PesananEccoController extends Controller
{
    public function index(Request $request){
        ...
        $pesanan =$query->join('addresses','addresses.id','=','pesanans.alamat')
            ...
            ->latest()->get();
        return view('finance/pesanan/pesanan',['pesanan'=>$pesanan,'tanggal_awal'=>$tanggal_awal,'tanggal_akhir'=>$tanggal_akhir]);
    }
    public function view_edit_pesanan(){
        return view('finance/pesanan/EditPesanan');
    }
    ...
    public function view_pesanan_selesai(Request $request){
        ...
        return view('finance/pesanan/pesanan_selesai',['pesanan'=>$pesanan]);
    }
    ...
    public function pesanan_selesai($id){
        ...
        if($ganti){ 
            ...
            $komisi_Korus->id_korus = $korus[0]->id;
            ...
            $komisi_rantus->id_rantus = $rantus[0]->id;
            ...
            $komisi_rantus->save();
        return redirect()->route('pesananfinance.view_selesai');
        }
        else{
            return redirect()->route('pesananfinance.view_selesai')->with('danger','TIdak bisa merubah pesanan');
        }
