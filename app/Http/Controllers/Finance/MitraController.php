...
class MitraController extends Controller
{
    ...
    public function input_mitra(Request $request){
        ...
        $mitras->save();
            return redirect()->route('finance.mitra')
