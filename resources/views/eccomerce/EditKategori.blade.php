    ...
    <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                      <!-- select -->
                      <form action="/admin/update_kategori/{{$kategoris->id}}" method="POST" enctype="multipart/form-data" role="form">
                      @csrf
                    ...
                    <div class="card-body">
                            ...
                            <div class="card-body">
                                ...
                                <a href="/admin/kategori" class="btn btn-secondary btn-lg " role="button" style ="float:right;">Cancel</a>
                            </div>
                        </form>
