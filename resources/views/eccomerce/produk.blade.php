                  ...
                  <tr>
                        ...
                        <div class="btn-group">
                          ...
                          <div class="dropdown-menu">
                            @switch($produk->visibilitas)
                              @case(1)
                                  <a class="dropdown-item" href="/admin/produk/hide/{{$produk->id}}">Sembunyikan Produk</a>
                                  @break
                              @default
                                  <a class="dropdown-item" href="/admin/produk/tampil/{{$produk->id}}">Tampilkan Produk</a>
                            @endswitch
                            <a class="dropdown-item" href="/admin/view_tambah_gambar_produk/{{$produk->id}}">Tambah Gambar</a>
                            <a class="dropdown-item" href="/admin/view_update_produk/{{$produk->id}}">Edit</a>
                            <a class="dropdown-item" href="/admin/hapus_produk/{{$produk->id}}">Delete</a>
                          </div>
                        </div>
                        </td>
                    </tr>
