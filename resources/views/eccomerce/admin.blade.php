        ...
        <div class="row">
          ...
          <div class="card">
             ...
             <!-- Button trigger modal -->
              <a href="/admin/tambah_admin" class="btn btn-success btn-lg active" role="button" aria-pressed="true" style ="float:right; font-size:15px;">Tambah Admin</a>
              </div>
                  ...
                  <tr>
                      ...
                      <td>
                        <div class="btn-group">
                          ...
                          <a class="dropdown-item" href="/admin/view_detail_user/{{$admin->id}}">Detail</a>
                          <a class="dropdown-item" href="/admin/view_update_admin/{{$admin->id}}">Edit</a>
                            <a class="dropdown-item" href="/admin/delete_admin/{{$admin->id}}">Delete</a>
                          </div>
                        </div>
                        </td>
                  </tr>
