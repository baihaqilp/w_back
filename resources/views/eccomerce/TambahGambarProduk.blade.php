    ...
    <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                      <!-- select -->
                      <form action="/admin/tambah_gambar_produk/{{$produk['id']}}" method="POST" enctype="multipart/form-data" role="form">
                      @csrf
                    ...
                    <div class="card-body">
                            ...
                            <button type="submit" class="btn btn-lg btn-primary" style="float:right;">
                                ...
                                <a href="/admin/admin" class="btn btn-secondary btn-lg " role="button" style ="float:right;padding top:20px;">Cancel</a>
