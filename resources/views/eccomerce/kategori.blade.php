                  ...
                  <div class="modal-content">
                    ...
                    <form action="{{route('kategori.create')}}" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" name="kategori_induk" id="kategori_induk"> 
                          <option value="" >-- Pilih Kategori Induk --</option>
                          @foreach($induks as $induk)
                          <option value="{{$induk->kategori_induk}}">{{$induk->kategori_induk}}</option>
                          @endforeach
                        </select>
                      </div>
                      <div class="form-group">
                    ...
                    <form action="{{route('kategori.create')}}" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" name="id_kategori" id="id_kategori"> 
                          <option value="" >-- Pilih Kategori Induk --</option>
                          @foreach($induks as $induk)
                          <option value="{{$induk->kategori_induk}}">{{$induk->nama_kategori}}</option>
                          @endforeach
                        </select>
                      </div>
                      <div class="form-group">
                  ...
                  <tr>
                        ...
                        <div class="btn-group">
                          ...
                          <div class="dropdown-menu">
                            <a class="dropdown-item" href="/admin/view_update_kategori/{{$kategori->id}}">Edit</a>
                            <a class="dropdown-item" href="/admin/hapus_kategori/{{$kategori->id}}">Delete</a>
                          </div>
                        </div>
                        </td>
                    </tr>
