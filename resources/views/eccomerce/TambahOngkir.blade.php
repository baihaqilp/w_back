            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                      ...
                      <!-- select -->
                      <form action="/admin/input_ongkir" method="POST" enctype="multipart/form-data" role="form">
                      @csrf
                    ...
                    <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <a href="/admin/tambah_ongkir" class="btn btn-secondary btn-lg " role="button" style ="float:right;">Cancel</a>
                            </div>
                        </form>
