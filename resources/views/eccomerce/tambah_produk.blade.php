            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                      ...
                      <!-- select -->
                      <form action="/admin/input_produk" method="POST" enctype="multipart/form-data" role="form">
                      @csrf
                        <!--<div class="card-body">                
                    ...
                    <div class="card-body">
                        ...
                        <div class="clone" hidden>    
                            <div class="control-group input-group" style="margin-top:10px">
                                ...
                                <div class="form-group">
                                    <label>Produk UMKM</label>
                                    <select class="form-control" id="umkm" name="umkm" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="mb-3">
                                        <textarea  required id="deskripsi" name="deskripsi" class="textarea" placeholder="Place some text here" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label>Alamat</label>
                                ...
                                <div class="form-group">
                                    <label>Kemasan</label>
                                    <input required type="text" class="form-control" id="kemasan" name="kemasan" placeholder="Kemasan">
                                </div>
                                <div class="form-group">
                                    ...
                                    <input  required type="text" class="form-control" name = "biaya_kirim"id="biaya_kirim">
                                    ...
                                    <label>Komponen Harga</label>
                                        <table class="table">
                                            <tr>
                                                ...
                                                <td><input type="number" id="kuantitas_beli" name ="kuantitas_beli"class="form-control col-sm-3"></td>
                                            </tr>
                                            <tr>
                                                ...
                                                <input type="text" class="form-control col-sm-3" name="harga_beli_pabrik" id="harga_beli_pabrik">
                                                </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <input type="text" class="form-control col-sm-3" name="biaya_kirim_pabrik" id="biaya_kirim_pabrik">
                                                </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <input type="text" class="form-control col-sm-3" name="biaya_kirim_gudang" id="biaya_kirim_gudang">
                                                </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <input type="text" class="form-control col-sm-3" name="biaya_bongkar_pabrik" id="biaya_bongkar_pabrik">
                                                </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <input type="text" class="form-control col-sm-3" name="biaya_bongkar_gudang" id="biaya_bongkar_gudang">
                                                </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <input type="text" class="form-control col-sm-3" name="overhead" id="overhead">
                                                </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <input readonly type="text" class="form-control col-sm-3" name="total_cogs" id="total_cogs">
                                                </div>
                                                </td>
                                            </tr>-->
                                            <tr>
                                                ...
                                                <input readonly type="text" class="form-control col-sm-3" id="cogs_satuan" name="cogs_satuan">
                                                </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <input type="text" class="form-control col-sm-3" id="margin" name="margin">
                                                </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <input readonly type="text" class="form-control col-sm-3" id="harga_jual_1" name="harga_jual_1">
                                                </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <input type="text" class="form-control col-sm-3" id="pajak" name="pajak">
                                                </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <input readonly type="text" class="form-control col-sm-3" id="harga_jual_final" name="harga_jual_final" >
                                                </div>
                                                </td>
                                            </tr>
                                        </table>
                                ...
                                <button type="submit" class="btn btn-lg btn-primary" style="float:right;">Simpan</button>
                                <a href="/admin/produk" class="btn btn-secondary btn-lg " role="button" style ="float:right;">Cancel</a>
                                <input type="button" onclick="calculate()" value="hitung" class="btn btn-lg btn-success" style ="float:right;"/>
                            </div>
                        </form>
