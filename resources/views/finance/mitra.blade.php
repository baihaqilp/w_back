        ...
        <div class="row">
          ...
          <div class="card">
             ...
             <!-- Button trigger modal -->
              <a href="/finance/tambah_mitra" class="btn btn-success btn-lg active" role="button" aria-pressed="true" style ="float:right; font-size:15px;">Tambah Mitra</a>
              </div>
                  ...
                  <tr>
                      ...
                      <td>
                        <div class="btn-group">
                          ...
                          <a class="dropdown-item" href="/finance/view_detail_mitra/{{$mitra->id}}">Detail</a>
                            <a class="dropdown-item" href="/finance/view_update_mitra/{{$mitra->id}}">Edit</a>
                          </div>
                        </div>
                        </td>
                  </tr>
