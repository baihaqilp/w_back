            ...
            <div class="row">
                ...
                <div class="col-sm-3" style="padding-top:30px;">
                  ...
                  <button type="text" name="btn-filter" id="btn-filter" class="btn btn-primary" onclick='window.location.reload();' >Refresh</button>
                    ...
                    <a href="/finance/tambah_berita" class="btn btn-success btn-lg active" role="button" aria-pressed="true" style ="float:right; font-size:15px;">Tambah Berita</a>
                <div class="card-body">
                  ...
                  <tr>
                        ...
                        <div class="btn-group">
                          ...
                          <div class="dropdown-menu">
                            <a class="dropdown-item" href="/finance/view_update_berita/{{$berita->id}}">Edit</a>
                          </div>
                        </div>
                        </td>
                    </tr>
